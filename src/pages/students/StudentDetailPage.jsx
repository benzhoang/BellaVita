...
// Tạo component InterestChannel trong file này
const InterestChannel = ({ title }) => {
    return (
        <div className="mx-2 my-4 p-4 bg-secondary rounded-lg shadow-md">
            <h3 className="font-bold text-center">{title}</h3>
            <div className="mt-2 text-center text-sm text-muted-foreground">
                Nội dung kênh quan tâm
            </div>
        </div>
    );
};
